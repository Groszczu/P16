...
#define KEY_VALUE_UP ((uint32_t)1)
#define KEY_VALUE_DOWN ((uint32_t)2)
#define KEY_VALUE_LEFT ((uint32_t)3)
#define KEY_VALUE_RIGHT ((uint32_t)4)
#define KEY_VALUE_PRESS ((uint32_t)5)
...
#define IO_KEY_1 GPIO_PIN_11
#define IO_KEY_2 GPIO_PIN_12
#define IO_KEY_3 GPIO_PIN_13
#define IO_KEY_4 GPIO_PIN_14
#define IO_KEY_5 GPIO_PIN_15
